...
Что именно делаем в настройках (MVP)
1️⃣ Изменить время утреннего напоминания

бот спрашивает время (08:30)

валидирует

сохраняет в UserSettings.morning_time

2️⃣ Изменить время вечернего напоминания

аналогично → evening_time

3️⃣ Изменить день начала недели

кнопки: Понедельник … Воскресенье

сохраняем week_start (ISO: 1–7)

4️⃣ Уведомления о пропусках

toggle: Включить / Выключить

меняем notify_missed_days
